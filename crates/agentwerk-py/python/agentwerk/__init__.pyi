...
class Condition:
    ...
    def __init__(self, query: "str | Query") -> None: ...
    def times(self, times: Optional[int]) -> "Condition": ...
    def agent(self, agent: "Agent") -> "Condition": ...
    def agents(self, agents: "list[Agent]") -> "Condition": ...
    def task(self, task: "Task | Any") -> "Condition": ...
    def tasks(self, tasks: "list[Any]") -> "Condition": ...
...
class Werk:
    ...
    def find_event(
        self, query: "Query | str | Callable[[Event], bool]"
    ) -> Optional[Event]: ...
    def find_events(
        self, query: "Query | str | Callable[[Event], bool]"
    ) -> list[Event]: ...
